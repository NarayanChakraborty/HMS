...
<?php include("header.php");?>
	...
	<div class="about-team"> 
			<h3 class="title1">Meet Our <span>Nurses</span></h3>
			...
			/* ===================== Pagination Code Starts ================== */
                          $adjacents = 7;
								...
								$statement = $db->prepare("SELECT * FROM nurse_details ");
								$statement->execute();
								...
								$start = 0;
											...
											$statement1 = $db->prepare("SELECT * FROM nurse_details LIMIT $start, $limit");
										    $statement1->execute();
